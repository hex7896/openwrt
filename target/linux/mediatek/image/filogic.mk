...
define Device/dlink_dir-x6080z
  DEVICE_VENDOR := D-Link
  DEVICE_MODEL := DIR-X6080Z
  DEVICE_DTS := mt7986a-dlink-dir-x6080z
  DEVICE_DTS_DIR := ../dts
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
  ...
  ARTIFACTS := preloader.bin bl31-uboot.fip
  ARTIFACT/preloader.bin := mt7986-bl2 spim-nand-ddr4
  ARTIFACT/bl31-uboot.fip := mt7986-bl31-uboot dlink_dir-x6080z
endef
TARGET_DEVICES += dlink_dir-x6080z
